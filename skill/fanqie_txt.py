...
charset = json.loads(
    '[["D", "在", "主", "特", "家", "在", "然", "能", "场", "4", "要", "只", "v", "和", "?", "6", "别", "还", "g", "高", "全", "岁", "活", "者", "此", "象", "主", "3", "出", "战", "工", "相", "o", "男", "年", "失", "中", "3", "特", "平", "文", "入", "要", "O", "将", "真", "T", "那", "当", "?", "会", "再", "些", "本", "是", "结", "1", "学", "世", "大", "爱", "说", "命", "全", "后", "东", "性", "美", "被", "1", "给", "9", "文", "而", "感", "车", "山", "公", "克", "常", "度", "何", "可", "话", "先", "p", "少", "叫", "打", "M", "常", "定", "间", "花", "见", "快", "l", "个", "风", "少", "色", "道", "第", "花", "远", "女", "山", "师", "放", "t", "的", "通", "面", "道", "S", "?", "克", "地", "度", "I", "神", "来", "U", "民", "四", "把", "万", "国", "水", "新", "没", "书", "电", "心", "像", "斯", "无", "为", "y", "代", "是", "好", "教", "看", "但", "种", "就", "候", "先", "上", "拉", "子", "有", "法", "r", "事", "应", "么", "利", "你", "了", "身", "国", "问", "马", "满", "眼", "Y", "比", "父", "x", "A", "H", "N", "可", "X", "边", "美", "对", "门", "明", "活", "回", "意", "到", "z", "从", "j", "战", "又", "内", "因", "点", "Q", "三", "定", "8", "R", "b", "变", "或", "机", "向", "德", "听", "一", "成", "生", "告", "并", "本", "q", "开", "记", "L", "让", "打", "小", "而", "后", "带", "以", "三", "满", "体", "做", "经", "K", "员", "如", "孩", "之", "学", "给", "人", "物", "?", "我", "笑", "乐", "?", "重", "等", "个", "k", "行", "一", "条", "书", "动", "光", "门", "头", "见", "家", "自", "解", "成", "处", "天", "能", "当", "名", "其", "发", "觉", "母", "的", "死", "手", "入", "路", "进", "心", "体", "太", "时", "万", "多", "开", "理", "许", "d", "至", "由", "很", "界", "着", "原", "她", "Z", "实", "代", "么", "分", "生", "口", "相", "妈", "大", "你", "西", "风", "种", "带", "J", "?", "样", "新", "才", "这", "最", "不", "我", "神", "格", "长", "觉", "间", "年", "眼", "无", "师", "亲", "知", "结", "0", "从", "信", "天", "却", "重", "己", "老", "2", "音", "快", "m", "呢", "明", "之", "8", "高", "头", "B", "至", "太", "点", "真", "手", "这", "她", "都", "界", "用", "法", "子", "英", "每", "又", "便", "四", "数", "期", "中", "C", "外", "有", "a", "果", "们", "任"], ["s", "?", "作", "口", "在", "他", "能", "并", "B", "士", "4", "U", "克", "才", "正", "们", "字", "声", "高", "全", "尔", "活", "者", "动", "其", "主", "报", "多", "望", "放", "h", "w", "次", "年", "?", "中", "3", "特", "于", "十", "入", "要", "男", "同", "G", "面", "分", "方", "K", "什", "再", "教", "本", "己", "结", "1", "等", "世", "N", "?", "说", "g", "u", "期", "Z", "外", "美", "M", "行", "给", "9", "文", "将", "两", "许", "张", "友", "0", "英", "应", "向", "像", "此", "白", "安", "少", "何", "打", "气", "常", "定", "间", "花", "见", "孩", "它", "直", "风", "数", "使", "道", "第", "水", "已", "女", "山", "解", "d", "P", "的", "通", "关", "性", "叫", "儿", "L", "妈", "问", "回", "神", "来", "S", "", "四", "望", "前", "国", "些", "O", "v", "l", "A", "心", "平", "自", "无", "军", "光", "代", "是", "好", "却", "c", "得", "种", "就", "意", "先", "立", "z", "子", "过", "Y", "j", "表", "", "么", "所", "接", "了", "名", "金", "受", "J", "满", "眼", "没", "部", "那", "m", "每", "车", "度", "可", "R", "斯", "经", "现", "门", "明", "V", "如", "走", "命", "y", "6", "E", "战", "很", "上", "f", "月", "西", "7", "长", "夫", "想", "话", "变", "海", "机", "x", "到", "W", "一", "成", "生", "信", "笑", "但", "父", "开", "内", "东", "马", "日", "小", "而", "后", "带", "以", "三", "几", "为", "认", "X", "死", "员", "目", "位", "之", "学", "远", "人", "音", "呢", "我", "q", "乐", "象", "重", "对", "个", "被", "别", "F", "也", "书", "稜", "D", "写", "还", "因", "家", "发", "时", "i", "或", "住", "德", "当", "o", "l", "比", "觉", "然", "吃", "去", "公", "a", "老", "亲", "情", "体", "太", "b", "万", "C", "电", "理", "?", "失", "力", "更", "拉", "物", "着", "原", "她", "工", "实", "色", "感", "记", "看", "出", "相", "路", "大", "你", "候", "2", "和", "?", "与", "p", "样", "新", "只", "便", "最", "不", "进", "T", "r", "做", "格", "母", "总", "爱", "身", "师", "轻", "知", "往", "加", "从", "?", "天", "e", "H", "?", "听", "场", "由", "快", "边", "让", "把", "任", "8", "条", "头", "事", "至", "起", "点", "真", "手", "这", "难", "都", "界", "用", "法", "n", "处", "下", "又", "Q", "告", "地", "5", "k", "t", "岁", "有", "会", "果", "利", "民"]]'
)
